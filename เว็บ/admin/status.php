...
<title>สถานะการยืมปริญญานิพนธ์</title>
</head>
...
<a href="" class="active w3-red">สถานะการยืมปริญญานิพนธ์</a>
 ...
 <br /><br />
    <center>
    <h2>สถานะการยืมปริญญานิพนธ์ </h2>
     <br /><br />
	<div class="form-group">
    <div class="input-group">
     <span class="input-group-addon">Search</span>
     <input type="text" name="search_text" id="search_text" placeholder="ค้นหาโดยใช้ชื่อผู้ยืม หรือ ชื่อปริญญานิพนธ์" class="form-control" style="z-index:0;"/>
    </div>
   </div>
