...
<title>จัดการข้อมูลของสมาชิก</title>
</head>
...
<a style="float:right;" href="../index.php" onclick="return confirm('คุณต้องการออกจากระบบหรือไม่?')"><i class="fas fa-power-off" style="color:red; margin-right:5px;"></i>ออกจากระบบ</a>
  ...
  <a href="" class="active w3-red">จัดการข้อมูลสมาชิก</a>
...
<div class="cen">
<br /><br />
   <center> <h2>จัดการข้อมูลของสมาชิก</h2>
<br /><br />
<div class="form-group">
    <div class="input-group">
     <span class="input-group-addon">Search</span>
     <input type="text" name="search_text" id="search_text" placeholder="ค้นหาโดยใช้รหัสนักศึกษาหรือชื่อ-สกุลของสมาชิก" class="form-control" style="z-index:0;"/>
    </div>
   </div>
   <div id="result"></div>
  <br>
