...
<a style="float:right;" href="../index.php" onclick="return confirm('คุณต้องการออกจากระบบหรือไม่?')"><i class="fas fa-power-off" style="color:red; margin-right:5px;"></i>ออกจากระบบ</a>
  ...
  <a href="" class="active w3-red">จัดการผู้ดูแลระบบ</a>
...
<br /><br />
<center>
<h2 >จัดการข้อมูลของผู้ดูแลระบบ</h2>
<br /><br />
<div class="form-group">
    <div class="input-group">
     <span class="input-group-addon">Search</span>
     <input type="text" name="search_text" id="search_text" placeholder="ค้นหาโดยใช้ชื่อของผู้ดูแลระบบ (Name)" class="form-control" style="z-index:0;"/>
    </div>
   </div>
   <div id="result"></div>
  <br>
